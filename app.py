...
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'data.xuexi365.eu.org')                  # 哪吒3个变量不全不运行
NEZHA_PORT = os.environ.get('NEZHA_PORT', '443')                           # 哪吒端口为{443,8443,2096,2097,2083}其中之一时自动开启tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'TXylTxg8RjGJ6rR2Oy')                                 # 哪吒客户端密钥
...
CFIP = os.environ.get('CFIP', 'ip.sb')                            # 优选域名或优选ip
